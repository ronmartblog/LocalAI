...
| ![NPU acceleration](docs/screenshots/11-npu-openvino.png) | **NPU acceleration** — INT4 chat running directly on the Intel® AI Boost NPU via OpenVINO (with automatic NPU→iGPU fallback for larger models). |
