...
MODELS = [{'id': 'qwen2.5:0.5b',
 ...
 {'id': 'granite3.2-vision',
  ...
  'vendor': 'IBM',
  'category': 'Vision',
  'description': "IBM's compact Granite 3.2 Vision model built for visual document understanding — "
                 'tables, charts, infographics, plots, and diagrams. Fast on CPU and a strong, '
                 'low-resource option for the Analyze → Prompt feature on the Image Generation page.',
  'parameters': '2.5B',
  'size_gb': 2.4,
  'min_ram_gb': 8,
  'min_vram_gb': 0,
  'context_length': 16384,
  'ollama_tag': 'granite3.2-vision',
  'onnx_repo': None,
  'benchmark_num_predict': 2048,
  'tags': ['vision', 'multimodal', 'image-analysis', 'analyze-prompt', 'document', 'ocr',
           'ollama', 'local-no-api'],
 ...
 {'id': 'gemma3:1b',
  ...
  'gpu_super_decision': 'accept-add'},
 {'id': 'ov-tinyllama-1.1b-int4',
  'name': 'TinyLlama 1.1B (OpenVINO INT4)',
  'vendor': 'OpenVINO',
  'category': 'Ultra Small',
  'description': 'TinyLlama 1.1B chat, pre-quantised to INT4 for OpenVINO. Smallest known-good '
                 'Intel NPU smoke test — loads fast on Intel(R) AI Boost and is the model the '
                 'Settings > Local Accelerators "Test NPU" button uses.',
  'parameters': '1.1B',
  'size_gb': 0.7,
  'min_ram_gb': 4,
  'min_vram_gb': 0,
  ...
  'onnx_repo': None,
  'backend': 'openvino',
  'ov_repo': 'OpenVINO/TinyLlama-1.1B-Chat-v1.0-int4-ov',
  'hf_revision': '72fd31b87453f00cb4dec2e92fa790c220d909bb',
  'recommended_device': 'NPU',
  'chat_selectable': True,
  'tags': ['npu', 'openvino', 'int4', 'chat']},
 {'id': 'ov-phi-3.5-mini-int4',
  'name': 'Phi-3.5 Mini (OpenVINO INT4)',
  'vendor': 'OpenVINO',
  'category': 'Small',
  'description': "Microsoft Phi-3.5-mini-instruct, INT4 for OpenVINO. Daily-driver chat on an "
                 'Intel NPU — strong quality for its size with low memory use.',
  'parameters': '3.8B',
  'size_gb': 2.3,
  'min_ram_gb': 8,
  'min_vram_gb': 0,
  ...
  'onnx_repo': None,
  'backend': 'openvino',
  'ov_repo': 'OpenVINO/Phi-3.5-mini-instruct-int4-ov',
  'hf_revision': '03cc3b1f99c6cb2b11cd17137642971712970b1f',
  'recommended_device': 'NPU',
  'chat_selectable': True,
  'tags': ['npu', 'openvino', 'int4', 'chat']},
 {'id': 'ov-qwen-2.5-1.5b-int4',
  'name': 'Qwen 2.5 1.5B (OpenVINO INT4)',
  'vendor': 'OpenVINO',
  'category': 'Ultra Small',
  'description': "Alibaba Qwen2.5-1.5B-Instruct, INT4 for OpenVINO. Fast alternate small model "
                 'for Intel NPU chat.',
  'parameters': '1.5B',
  'size_gb': 1.0,
  'min_ram_gb': 4,
  ...
  'onnx_repo': None,
  'backend': 'openvino',
  'ov_repo': 'OpenVINO/Qwen2.5-1.5B-Instruct-int4-ov',
  'hf_revision': '4d14c299e35d8b74e3471f9e92bd1377fae50736',
  'recommended_device': 'NPU',
  'chat_selectable': True,
  'tags': ['npu', 'openvino', 'int4', 'chat']},
 {'id': 'ov-mistral-7b-int4',
  'name': 'Mistral 7B v0.3 (OpenVINO INT4)',
  'vendor': 'OpenVINO',
  'category': 'Medium',
  'description': 'Mistral-7B-Instruct v0.3, INT4 for OpenVINO. Recommended on the Intel iGPU '
                 '(7B exceeds typical NPU L2), so it also exercises the NPU->GPU fallback path.',
  'parameters': '7B',
  'size_gb': 4.3,
  'min_ram_gb': 12,
  'min_vram_gb': 0,
  ...
  'onnx_repo': None,
  'backend': 'openvino',
  'ov_repo': 'OpenVINO/Mistral-7B-Instruct-v0.3-int4-ov',
  'hf_revision': '48ff2bf3fe0134f1a518afe0023926c8a09565f5',
